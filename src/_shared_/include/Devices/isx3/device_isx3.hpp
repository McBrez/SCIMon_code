...
private:
   ...
   * @param impedanceSpectrum std::list of impedance spectrums that only contain
   * a single freuquency point. It is expected that those impedance spectrums
   * all correspond to a single timestamp.
